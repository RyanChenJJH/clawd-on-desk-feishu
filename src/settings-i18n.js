...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarHealthReminder: "Health",
      sidebarTelegramApproval: "Remote Approval",
      remoteApprovalTitle: "Remote Approval",
      remoteApprovalSubtitle: "Route local permission prompts to optional remote channels. Secrets stay outside prefs and the desktop bubble remains the local fallback. Telegram and Feishu can be enabled together; the first decision wins.",
      ...
      feishuApprovalCardFailed: "Feishu approval reported a failure. Check the message below or retry.",
      feishuApprovalCardRunning: "Feishu approval is live. Approval cards will route to your bot.",
      feishuApprovalCardStarting: "Connecting to Feishu approval…",
      feishuApprovalCardReadyToEnable: "Credentials, recipient, and approver are saved. Flip the switch to enable Feishu approval.",
      feishuApprovalStep1Title: "1. App credentials",
      feishuApprovalCredentialsLabel: "App ID and App Secret",
      feishuApprovalCredentialsHint: "Create a self-built app bot in Feishu or Lark, then paste its App ID and App Secret here. The secret is stored in the user-data env file, never in prefs.",
      feishuApprovalCredentialsReplaceHint: "Pasting new credentials replaces the saved App ID and App Secret.",
      feishuApprovalAppIdPlaceholder: "cli_xxx",
      feishuApprovalAppSecretPlaceholder: "Paste App Secret",
      feishuApprovalSaveCredentials: "Save credentials",
      feishuApprovalCredentialsEmpty: "Enter both App ID and App Secret first.",
      feishuApprovalCredentialsSaved: "Feishu credentials saved.",
      feishuApprovalCredentialsSaveFailed: "Could not save Feishu credentials.",
      feishuApprovalCredentialsConfiguredLabel: "Credentials configured",
      feishuApprovalSecretConfiguredNoMask: "(stored)",
      feishuApprovalCredentialsConfiguredDesc: "Saved App ID: {appId}. The App Secret is masked and kept outside prefs.",
      feishuApprovalAppIdUnknown: "(unknown App ID)",
      feishuApprovalReplaceCredentials: "Replace credentials",
      feishuApprovalDeleteCredentials: "Delete credentials",
      feishuApprovalCredentialsDeleted: "Feishu credentials deleted.",
      feishuApprovalCredentialsDeleteFailed: "Could not delete Feishu credentials.",
      feishuApprovalCredentialsCurrent: "Current App ID: {appId}",
      feishuApprovalStep2Title: "2. Recipient",
      feishuApprovalRecipientLabel: "Target chat and approver",
      feishuApprovalRecipientHint: "Pick Feishu or Lark, enter the receive id to send cards to, and enter at least one allowed approver id.",
      feishuApprovalRegion_feishu: "Feishu",
      feishuApprovalRegion_lark: "Lark",
      feishuApprovalReceiveIdType_chat_id: "chat_id",
      feishuApprovalReceiveIdType_open_id: "open_id",
      feishuApprovalReceiveIdType_user_id: "user_id",
      feishuApprovalReceiveIdPlaceholder: "Receive ID, e.g. oc_xxx",
      feishuApprovalAllowedOpenIdPlaceholder: "Allowed open_id, e.g. ou_xxx",
      feishuApprovalAllowedUserIdPlaceholder: "Allowed user_id (optional)",
      feishuApprovalSaveRecipient: "Save recipient",
      feishuApprovalReceiveIdEmpty: "Enter a Feishu receive id first.",
      feishuApprovalApproverEmpty: "Enter an allowed open_id or user_id first.",
      ...
      feishuApprovalToggleDesc: "When configured, actionable local permission bubbles can also send an approval card to Feishu. The local bubble remains active.",
      feishuApprovalTest: "Test card",
      feishuApprovalTestDesc: "Sends a standalone Feishu test approval card. It is not attached to any live permission request.",
      ...
      feishuApprovalTestLogTitle: "Send test log",
      feishuApprovalTestLogPending: "Preparing the Feishu test card…",
      feishuApprovalPrereqLabel: "Finish Feishu setup first",
      feishuApprovalPrereqDesc: "Still needed:",
      feishuApprovalPrereqMissingCredentials: "app credentials",
      feishuApprovalPrereqMissingRecipient: "receive id",
      feishuApprovalPrereqMissingApprover: "allowed approver",
      ...
      animOverridesSectionHealth: "Health Reminders",
      animHealthDrink: "Drink water",
      animHealthStretch: "Stand & stretch",
      animHealthEat: "Meal time",
      animHealthOffwork: "Off work",
      animHealthEyerest: "Eye rest",
      animHealthBreathe: "Deep breathing",
      animHealthPosture: "Sit up straight",
      animHealthWalk: "Take a walk",
      animHealthSnack: "Healthy snack",
      animHealthSleeptime: "Bedtime",
    ...
    zh: {
      ...
      sidebarMobile: "移动端",
      sidebarHealthReminder: "健康提醒",
      sidebarTelegramApproval: "远程审批",
      remoteApprovalTitle: "远程审批",
      remoteApprovalSubtitle: "把本地权限请求路由到可选远程渠道。密钥不写入 prefs，本地权限气泡仍然保留作为兜底。Telegram 和飞书可以同时启用，先到的审批决定生效。",
      telegramApprovalChannelName: "Telegram",
      ...
      feishuApprovalCardFailed: "飞书审批报错。请查看下方信息或重试。",
      feishuApprovalCardRunning: "飞书审批运行中，审批卡会发送到你的机器人。",
      feishuApprovalCardStarting: "正在连接飞书审批…",
      feishuApprovalCardReadyToEnable: "凭据、接收目标和审批人都已保存，打开开关即可启用飞书审批。",
      feishuApprovalStep1Title: "1. 应用凭据",
      feishuApprovalCredentialsLabel: "App ID 和 App Secret",
      feishuApprovalCredentialsHint: "在飞书或 Lark 创建企业自建应用机器人，然后把 App ID 和 App Secret 粘贴到这里。Secret 存到 userData env 文件，不会写入 prefs。",
      feishuApprovalCredentialsReplaceHint: "粘贴新凭据会替换已保存的 App ID 和 App Secret。",
      feishuApprovalAppIdPlaceholder: "cli_xxx",
      feishuApprovalAppSecretPlaceholder: "粘贴 App Secret",
      feishuApprovalSaveCredentials: "保存凭据",
      feishuApprovalCredentialsEmpty: "请先填写 App ID 和 App Secret。",
      feishuApprovalCredentialsSaved: "飞书凭据已保存。",
      feishuApprovalCredentialsSaveFailed: "无法保存飞书凭据。",
      feishuApprovalCredentialsConfiguredLabel: "凭据已配置",
      feishuApprovalSecretConfiguredNoMask: "（已存）",
      feishuApprovalCredentialsConfiguredDesc: "已保存 App ID：{appId}。App Secret 已脱敏显示，并保存在 prefs 之外。",
      feishuApprovalAppIdUnknown: "（未知 App ID）",
      feishuApprovalReplaceCredentials: "更换凭据",
      feishuApprovalDeleteCredentials: "删除凭据",
      feishuApprovalCredentialsDeleted: "飞书凭据已删除。",
      feishuApprovalCredentialsDeleteFailed: "无法删除飞书凭据。",
      feishuApprovalCredentialsCurrent: "当前 App ID：{appId}",
      feishuApprovalStep2Title: "2. 接收目标",
      feishuApprovalRecipientLabel: "目标会话和审批人",
      feishuApprovalRecipientHint: "选择飞书或 Lark，填写接收审批卡的 receive id，并至少填写一个允许审批人的 ID。",
      feishuApprovalRegion_feishu: "飞书",
      feishuApprovalRegion_lark: "Lark",
      feishuApprovalReceiveIdType_chat_id: "chat_id",
      feishuApprovalReceiveIdType_open_id: "open_id",
      feishuApprovalReceiveIdType_user_id: "user_id",
      feishuApprovalReceiveIdPlaceholder: "Receive ID，例如 oc_xxx",
      feishuApprovalAllowedOpenIdPlaceholder: "允许审批的 open_id，例如 ou_xxx",
      feishuApprovalAllowedUserIdPlaceholder: "允许审批的 user_id（可选）",
      feishuApprovalSaveRecipient: "保存接收目标",
      feishuApprovalReceiveIdEmpty: "请先填写飞书 receive id。",
      feishuApprovalApproverEmpty: "请先填写允许审批的 open_id 或 user_id。",
      feishuApprovalConfigSaved: "飞书审批配置已保存。",
      feishuApprovalStep3Title: "3. 启用与测试",
      feishuApprovalToggle: "启用飞书审批",
      feishuApprovalToggleDesc: "配置完成后，可操作的本地权限气泡也可以发送一张飞书审批卡。本地气泡仍会保留。",
      feishuApprovalTest: "测试卡片",
      feishuApprovalTestDesc: "发送一张独立飞书测试审批卡，不绑定任何真实权限请求。",
      feishuApprovalSendTest: "发送测试",
      feishuApprovalTesting: "等待中…",
      feishuApprovalTestSent: "飞书测试完成。",
      feishuApprovalTestFailed: "飞书测试失败。",
      feishuApprovalTestLogTitle: "发送测试日志",
      feishuApprovalTestLogPending: "正在准备飞书测试卡片…",
      feishuApprovalPrereqLabel: "请先完成飞书配置",
      feishuApprovalPrereqDesc: "还差：",
      feishuApprovalPrereqMissingCredentials: "应用凭据",
      feishuApprovalPrereqMissingRecipient: "receive id",
      feishuApprovalPrereqMissingApprover: "允许审批人",
      ...
      animOverridesSectionHealth: "健康提醒动画",
      animHealthDrink: "喝水",
      animHealthStretch: "起身伸展",
      animHealthEat: "吃饭时间",
      animHealthOffwork: "下班",
      animHealthEyerest: "护眼远眺",
      animHealthBreathe: "深呼吸",
      animHealthPosture: "端正坐姿",
      animHealthWalk: "走动一下",
      animHealthSnack: "吃点水果",
      animHealthSleeptime: "该睡觉了",
    ...
    "zh-TW": {
      ...
      remoteApprovalSubtitle: "將本機權限請求路由到可選遠端通道。密鑰不會寫入 prefs，本機權限泡泡仍保留為備援。Telegram 和飛書可以同時啟用，先到的核准決定生效。",
      telegramApprovalChannelName: "Telegram",
      ...
      feishuApprovalCardFailed: "飛書核准回報失敗。請看下方訊息或重試。",
      feishuApprovalCardRunning: "飛書核准運作中，核准卡片會送到你的機器人。",
      feishuApprovalCardStarting: "正在連線到飛書核准…",
      feishuApprovalCardReadyToEnable: "憑證、接收目標與核准者皆已儲存，打開開關即可啟用飛書核准。",
      feishuApprovalStep1Title: "1. 應用憑證",
      feishuApprovalCredentialsLabel: "App ID 與 App Secret",
      feishuApprovalCredentialsHint: "在飛書或 Lark 建立企業自建應用機器人，然後把 App ID 和 App Secret 貼到這裡。Secret 會存到 userData env 檔，不會寫入 prefs。",
      feishuApprovalCredentialsReplaceHint: "貼上新憑證會取代已儲存的 App ID 與 App Secret。",
      feishuApprovalAppIdPlaceholder: "cli_xxx",
      feishuApprovalAppSecretPlaceholder: "貼上 App Secret",
      feishuApprovalSaveCredentials: "儲存憑證",
      feishuApprovalCredentialsEmpty: "請先填寫 App ID 與 App Secret。",
      feishuApprovalCredentialsSaved: "飛書憑證已儲存。",
      feishuApprovalCredentialsSaveFailed: "無法儲存飛書憑證。",
      feishuApprovalCredentialsConfiguredLabel: "憑證已設定",
      feishuApprovalSecretConfiguredNoMask: "（已儲存）",
      feishuApprovalCredentialsConfiguredDesc: "已儲存 App ID：{appId}。App Secret 會遮罩顯示，並保存在 prefs 之外。",
      feishuApprovalAppIdUnknown: "（未知 App ID）",
      feishuApprovalReplaceCredentials: "更換憑證",
      feishuApprovalDeleteCredentials: "刪除憑證",
      feishuApprovalCredentialsDeleted: "飛書憑證已刪除。",
      feishuApprovalCredentialsDeleteFailed: "無法刪除飛書憑證。",
      feishuApprovalCredentialsCurrent: "目前 App ID：{appId}",
      feishuApprovalStep2Title: "2. 接收目標",
      feishuApprovalRecipientLabel: "目標會話與核准者",
      feishuApprovalRecipientHint: "選擇飛書或 Lark，填寫接收核准卡的 receive id，並至少填一個允許核准者 ID。",
      feishuApprovalRegion_feishu: "飛書",
      feishuApprovalRegion_lark: "Lark",
      feishuApprovalReceiveIdType_chat_id: "chat_id",
      feishuApprovalReceiveIdType_open_id: "open_id",
      feishuApprovalReceiveIdType_user_id: "user_id",
      feishuApprovalReceiveIdPlaceholder: "Receive ID，例如 oc_xxx",
      feishuApprovalAllowedOpenIdPlaceholder: "允許核准的 open_id，例如 ou_xxx",
      feishuApprovalAllowedUserIdPlaceholder: "允許核准的 user_id（可選）",
      feishuApprovalSaveRecipient: "儲存接收目標",
      feishuApprovalReceiveIdEmpty: "請先填寫飛書 receive id。",
      feishuApprovalApproverEmpty: "請先填寫允許核准的 open_id 或 user_id。",
      feishuApprovalConfigSaved: "飛書核准設定已儲存。",
      feishuApprovalStep3Title: "3. 啟用與測試",
      feishuApprovalToggle: "啟用飛書核准",
      feishuApprovalToggleDesc: "設定完成後，可操作的本機權限泡泡也可以送出飛書核准卡。本機泡泡仍會保留。",
      feishuApprovalTest: "測試卡片",
      feishuApprovalTestDesc: "送出一張獨立飛書測試核准卡，不綁定任何真實權限請求。",
      feishuApprovalSendTest: "送出測試",
      feishuApprovalTesting: "等待中…",
      feishuApprovalTestSent: "飛書測試完成。",
      feishuApprovalTestFailed: "飛書測試失敗。",
      feishuApprovalTestLogTitle: "送出測試記錄",
      feishuApprovalTestLogPending: "正在準備飛書測試卡片…",
      feishuApprovalPrereqLabel: "請先完成飛書設定",
      feishuApprovalPrereqDesc: "還缺：",
      feishuApprovalPrereqMissingCredentials: "應用憑證",
      feishuApprovalPrereqMissingRecipient: "receive id",
      feishuApprovalPrereqMissingApprover: "允許核准者",
      ...
      animOverridesSectionHealth: "健康提醒動畫",
      animHealthDrink: "喝水",
      animHealthStretch: "起身伸展",
      animHealthEat: "用餐時間",
      animHealthOffwork: "下班",
      animHealthEyerest: "護眼遠眺",
      animHealthBreathe: "深呼吸",
      animHealthPosture: "端正坐姿",
      animHealthWalk: "走動一下",
      animHealthSnack: "吃點水果",
      animHealthSleeptime: "該睡覺了",
    ...
    ko: {
      ...
      sidebarMobile: "모바일",
      sidebarHealthReminder: "건강 알림",
      sidebarTelegramApproval: "원격 승인",
      remoteApprovalTitle: "원격 승인",
      remoteApprovalSubtitle: "로컬 권한 요청을 선택적 원격 채널로 라우팅합니다. 비밀값은 prefs에 저장하지 않으며 데스크톱 버블은 로컬 fallback으로 유지됩니다. Telegram과 Feishu를 함께 켤 수 있고, 먼저 도착한 결정이 적용됩니다.",
      telegramApprovalChannelName: "Telegram",
      ...
      feishuApprovalChannelName: "Feishu / Lark",
      feishuApprovalCardFailed: "Feishu 승인이 실패를 보고했습니다. 아래 메시지를 확인하거나 다시 시도하세요.",
      feishuApprovalCardRunning: "Feishu 승인이 실행 중입니다. 승인 카드가 bot으로 전달됩니다.",
      feishuApprovalCardStarting: "Feishu 승인에 연결 중…",
      feishuApprovalCardReadyToEnable: "자격 증명, 수신 대상, 승인자가 저장되었습니다. 스위치를 켜면 Feishu 승인이 활성화됩니다.",
      feishuApprovalStep1Title: "1. 앱 자격 증명",
      feishuApprovalCredentialsLabel: "App ID 및 App Secret",
      feishuApprovalCredentialsHint: "Feishu 또는 Lark에서 자체 구축 앱 bot을 만든 뒤 App ID와 App Secret을 여기에 붙여넣으세요. Secret은 userData env 파일에 저장되며 prefs에는 저장되지 않습니다.",
      feishuApprovalCredentialsReplaceHint: "새 자격 증명을 붙여넣으면 저장된 App ID와 App Secret이 교체됩니다.",
      feishuApprovalAppIdPlaceholder: "cli_xxx",
      feishuApprovalAppSecretPlaceholder: "App Secret 붙여넣기",
      feishuApprovalSaveCredentials: "자격 증명 저장",
      feishuApprovalCredentialsEmpty: "App ID와 App Secret을 먼저 입력하세요.",
      feishuApprovalCredentialsSaved: "Feishu 자격 증명이 저장되었습니다.",
      feishuApprovalCredentialsSaveFailed: "Feishu 자격 증명을 저장할 수 없습니다.",
      feishuApprovalCredentialsConfiguredLabel: "자격 증명 설정됨",
      feishuApprovalSecretConfiguredNoMask: "(저장됨)",
      feishuApprovalCredentialsConfiguredDesc: "저장된 App ID: {appId}. App Secret은 마스킹되어 prefs 밖에 보관됩니다.",
      feishuApprovalAppIdUnknown: "(알 수 없는 App ID)",
      feishuApprovalReplaceCredentials: "자격 증명 교체",
      feishuApprovalDeleteCredentials: "자격 증명 삭제",
      feishuApprovalCredentialsDeleted: "Feishu 자격 증명이 삭제되었습니다.",
      feishuApprovalCredentialsDeleteFailed: "Feishu 자격 증명을 삭제할 수 없습니다.",
      feishuApprovalCredentialsCurrent: "현재 App ID: {appId}",
      feishuApprovalStep2Title: "2. 수신 대상",
      feishuApprovalRecipientLabel: "대상 채팅 및 승인자",
      feishuApprovalRecipientHint: "Feishu 또는 Lark를 선택하고 승인 카드를 받을 receive id와 허용 승인자 ID를 하나 이상 입력하세요.",
      feishuApprovalRegion_feishu: "Feishu",
      feishuApprovalRegion_lark: "Lark",
      feishuApprovalReceiveIdType_chat_id: "chat_id",
      feishuApprovalReceiveIdType_open_id: "open_id",
      feishuApprovalReceiveIdType_user_id: "user_id",
      feishuApprovalReceiveIdPlaceholder: "Receive ID, 예: oc_xxx",
      feishuApprovalAllowedOpenIdPlaceholder: "허용 open_id, 예: ou_xxx",
      feishuApprovalAllowedUserIdPlaceholder: "허용 user_id (선택)",
      feishuApprovalSaveRecipient: "수신 대상 저장",
      feishuApprovalReceiveIdEmpty: "Feishu receive id를 먼저 입력하세요.",
      feishuApprovalApproverEmpty: "허용 open_id 또는 user_id를 먼저 입력하세요.",
      feishuApprovalConfigSaved: "Feishu 승인 설정이 저장되었습니다.",
      feishuApprovalStep3Title: "3. 활성화 및 테스트",
      feishuApprovalToggle: "Feishu 승인 활성화",
      feishuApprovalToggleDesc: "설정되면 처리 가능한 로컬 권한 버블이 Feishu 승인 카드도 보낼 수 있습니다. 로컬 버블은 계속 유지됩니다.",
      feishuApprovalTest: "테스트 카드",
      feishuApprovalTestDesc: "실제 권한 요청에 연결되지 않은 독립 Feishu 테스트 승인 카드를 보냅니다.",
      feishuApprovalSendTest: "테스트 보내기",
      feishuApprovalTesting: "대기 중…",
      feishuApprovalTestSent: "Feishu 테스트가 완료되었습니다.",
      feishuApprovalTestFailed: "Feishu 테스트 실패.",
      feishuApprovalTestLogTitle: "테스트 전송 로그",
      feishuApprovalTestLogPending: "Feishu 테스트 카드를 준비하는 중…",
      feishuApprovalPrereqLabel: "먼저 Feishu 설정을 완료하세요",
      feishuApprovalPrereqDesc: "아직 필요한 것:",
      feishuApprovalPrereqMissingCredentials: "앱 자격 증명",
      feishuApprovalPrereqMissingRecipient: "receive id",
      feishuApprovalPrereqMissingApprover: "허용 승인자",
      ...
      animOverridesSectionHealth: "건강 알림 애니메이션",
      animHealthDrink: "물 마시기",
      animHealthStretch: "일어나 스트레칭",
      animHealthEat: "식사 시간",
      animHealthOffwork: "퇴근",
      animHealthEyerest: "눈 휴식",
      animHealthBreathe: "심호흡",
      animHealthPosture: "바른 자세",
      animHealthWalk: "잠깐 걷기",
      animHealthSnack: "간식 먹기",
      animHealthSleeptime: "잘 시간",
    ...
    ja: {
      ...
      sidebarMobile: "モバイル",
      sidebarHealthReminder: "健康リマインダー",
      sidebarTelegramApproval: "リモート承認",
      remoteApprovalTitle: "リモート承認",
      remoteApprovalSubtitle: "ローカルの権限リクエストを任意のリモートチャンネルへルーティングします。秘密情報は prefs に保存せず、デスクトップの吹き出しはローカル fallback として残ります。Telegram と Feishu は同時に有効化でき、先に届いた判断が適用されます。",
      telegramApprovalChannelName: "Telegram",
      ...
      feishuApprovalChannelName: "Feishu / Lark",
      feishuApprovalCardFailed: "Feishu 承認で失敗が報告されました。下のメッセージを確認するか再試行してください。",
      feishuApprovalCardRunning: "Feishu 承認が稼働中です。承認カードが bot に送信されます。",
      feishuApprovalCardStarting: "Feishu 承認に接続中…",
      feishuApprovalCardReadyToEnable: "認証情報、送信先、承認者が保存済みです。スイッチを入れると Feishu 承認を有効化します。",
      feishuApprovalStep1Title: "1. アプリ認証情報",
      feishuApprovalCredentialsLabel: "App ID と App Secret",
      feishuApprovalCredentialsHint: "Feishu または Lark で自社アプリ bot を作成し、App ID と App Secret をここに貼り付けます。Secret は userData env ファイルに保存され、prefs には保存されません。",
      feishuApprovalCredentialsReplaceHint: "新しい認証情報を貼り付けると、保存済みの App ID と App Secret を置き換えます。",
      feishuApprovalAppIdPlaceholder: "cli_xxx",
      feishuApprovalAppSecretPlaceholder: "App Secret を貼り付け",
      feishuApprovalSaveCredentials: "認証情報を保存",
      feishuApprovalCredentialsEmpty: "先に App ID と App Secret を入力してください。",
      feishuApprovalCredentialsSaved: "Feishu 認証情報を保存しました。",
      feishuApprovalCredentialsSaveFailed: "Feishu 認証情報を保存できません。",
      feishuApprovalCredentialsConfiguredLabel: "認証情報設定済み",
      feishuApprovalSecretConfiguredNoMask: "（保存済み）",
      feishuApprovalCredentialsConfiguredDesc: "保存済み App ID: {appId}。App Secret はマスクされ、prefs の外に保存されます。",
      feishuApprovalAppIdUnknown: "（不明な App ID）",
      feishuApprovalReplaceCredentials: "認証情報を変更",
      feishuApprovalDeleteCredentials: "認証情報を削除",
      feishuApprovalCredentialsDeleted: "Feishu 認証情報を削除しました。",
      feishuApprovalCredentialsDeleteFailed: "Feishu 認証情報を削除できません。",
      feishuApprovalCredentialsCurrent: "現在の App ID: {appId}",
      feishuApprovalStep2Title: "2. 送信先",
      feishuApprovalRecipientLabel: "対象チャットと承認者",
      feishuApprovalRecipientHint: "Feishu または Lark を選び、承認カードの送信先 receive id と、許可する承認者 ID を少なくとも 1 つ入力します。",
      feishuApprovalRegion_feishu: "Feishu",
      feishuApprovalRegion_lark: "Lark",
      feishuApprovalReceiveIdType_chat_id: "chat_id",
      feishuApprovalReceiveIdType_open_id: "open_id",
      feishuApprovalReceiveIdType_user_id: "user_id",
      feishuApprovalReceiveIdPlaceholder: "Receive ID、例: oc_xxx",
      feishuApprovalAllowedOpenIdPlaceholder: "許可する open_id、例: ou_xxx",
      feishuApprovalAllowedUserIdPlaceholder: "許可する user_id（任意）",
      feishuApprovalSaveRecipient: "送信先を保存",
      feishuApprovalReceiveIdEmpty: "先に Feishu receive id を入力してください。",
      feishuApprovalApproverEmpty: "先に許可する open_id または user_id を入力してください。",
      feishuApprovalConfigSaved: "Feishu 承認設定を保存しました。",
      feishuApprovalStep3Title: "3. 有効化とテスト",
      feishuApprovalToggle: "Feishu 承認を有効化",
      feishuApprovalToggleDesc: "設定済みの場合、操作可能なローカル権限吹き出しから Feishu 承認カードも送信できます。ローカル吹き出しは引き続き残ります。",
      feishuApprovalTest: "テストカード",
      feishuApprovalTestDesc: "実際の権限リクエストに紐づかない単独の Feishu テスト承認カードを送ります。",
      feishuApprovalSendTest: "テスト送信",
      feishuApprovalTesting: "待機中…",
      feishuApprovalTestSent: "Feishu テストが完了しました。",
      feishuApprovalTestFailed: "Feishu テストに失敗しました。",
      feishuApprovalTestLogTitle: "テスト送信ログ",
      feishuApprovalTestLogPending: "Feishu テストカードを準備しています…",
      feishuApprovalPrereqLabel: "先に Feishu 設定を完了してください",
      feishuApprovalPrereqDesc: "まだ必要なもの:",
      feishuApprovalPrereqMissingCredentials: "アプリ認証情報",
      feishuApprovalPrereqMissingRecipient: "receive id",
      feishuApprovalPrereqMissingApprover: "許可する承認者",
      ...
      animOverridesSectionHealth: "健康リマインダー",
      animHealthDrink: "水分補給",
      animHealthStretch: "立って伸び",
      animHealthEat: "食事の時間",
      animHealthOffwork: "退勤",
      animHealthEyerest: "目の休憩",
      animHealthBreathe: "深呼吸",
      animHealthPosture: "姿勢を正す",
      animHealthWalk: "少し歩く",
      animHealthSnack: "軽食をとる",
      animHealthSleeptime: "就寝時間",
  ...
  const FEISHU_COMPLETION_SETTINGS_COPY = {
    en: {
      feishuApprovalNotifyOnComplete: "Completion notifications",
      feishuApprovalNotifyOnCompleteDesc: "Send a Feishu / Lark message when a live session completes. Feishu approval must still be enabled before messages are sent.",
      feishuApprovalCompletionOutput: "Completion output",
      feishuApprovalCompletionOutputDesc: "Controls whether Feishu / Lark completion notifications include assistant text. Full answer may include code, file contents, or secrets if the assistant wrote them.",
      feishuApprovalCompletionOutput_off: "Off",
      feishuApprovalCompletionOutput_full: "Full answer",
      feishuApprovalCompletionOutputFullConfirm: "Full answer sends the assistant's final text to Feishu / Lark. It may include code, file contents, or secrets if the assistant wrote them. Continue?",
    },
    zh: {
      feishuApprovalNotifyOnComplete: "Completion notifications",
      feishuApprovalNotifyOnCompleteDesc: "Send a Feishu / Lark message when a live session completes. Feishu approval must still be enabled before messages are sent.",
  ...
  for (const [lang, copy] of Object.entries(FEISHU_COMPLETION_SETTINGS_COPY)) {
    if (STRINGS[lang]) Object.assign(STRINGS[lang], copy);
  }

  // v3 (fork): Feishu answer-in-chat. Kept in a separate copy block so it merges
  // cleanly and stays easy to lift out when syncing upstream.
  const FEISHU_V3_SETTINGS_COPY = {
    en: {
      feishuApprovalElicitation: "Answer questions in Feishu",
      feishuApprovalElicitationDesc: "When Claude asks you to choose (AskUserQuestion), send it to Feishu / Lark with option buttons; reply with text for a custom answer. Off by default.",
    },
    zh: {
      feishuApprovalElicitation: "在飞书回答提问",
      feishuApprovalElicitationDesc: "当 Claude 让你做选择（AskUserQuestion）时，把问题发到飞书 / Lark，选项以按钮呈现；回复文本即可自定义作答。默认关闭。",
    },
    "zh-TW": {
      feishuApprovalElicitation: "在飛書回答提問",
      feishuApprovalElicitationDesc: "當 Claude 要你做選擇（AskUserQuestion）時，把問題發到飛書 / Lark，選項以按鈕呈現；回覆文字即可自訂作答。預設關閉。",
    },
    ko: {
      feishuApprovalElicitation: "Answer questions in Feishu",
      feishuApprovalElicitationDesc: "When Claude asks you to choose (AskUserQuestion), send it to Feishu / Lark with option buttons; reply with text for a custom answer. Off by default.",
  ...
  for (const [lang, copy] of Object.entries(FEISHU_V3_SETTINGS_COPY)) {
    if (STRINGS[lang]) Object.assign(STRINGS[lang], copy);
  }
